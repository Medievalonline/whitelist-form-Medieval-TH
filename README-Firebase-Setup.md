...
- `whitelist-form.html`, `streamer-form.html`, `admin-chop-hee.html` — เพิ่ม 2 บรรทัด `<script src="...">`
...
- รายชื่อ `STAFF_DISCORD_IDS` ใน `admin-chop-hee.html` เป็นแค่การกรอง UI ฝั่ง browser ไม่ใช่การตรวจสอบสิทธิ์จริง
